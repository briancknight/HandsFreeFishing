...
def main():
    ...
    for im_path in im_paths:
        ...
        fish = fin_clipping.fish(im_path, predictor,write_mask=False)
        fish.run()
        school.append(fish)
    ...
    if save_xlsx:
        ...
        df.to_excel('measurements/'+dir_name+'/output.xlsx')
